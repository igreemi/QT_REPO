...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        te_sendMsg = new QTextEdit(centralwidget);
        te_sendMsg->setObjectName("te_sendMsg");

        verticalLayout->addWidget(te_sendMsg);

        pb_sendMsg = new QPushButton(centralwidget);
        pb_sendMsg->setObjectName("pb_sendMsg");

        verticalLayout->addWidget(pb_sendMsg);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pb_sendMsg->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
    } // retranslateUi
